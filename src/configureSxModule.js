define([
	...
	'fontoxml-families/createOrderingByAttributeWidget',
	...
	return function configureSxModule (sxModule) {
		...
		configureProperties(sxModule, 'self::lcAnswerOption2[parent::*/parent::*[self::lcSingleSelect2 or self::lcTrueFalse2]]', {
		...
		configureProperties(sxModule, 'self::lcAnswerOption2[parent::*/parent::lcMultipleSelect2 and child::lcCorrectResponse2]', {
			markupLabel: t('correct answer option'),
			blockBefore: [
		...
		configureAsFrame(sxModule, 'self::lcSequenceOption2', t('answer option'), {
			...
			blockBefore: [
				createOrderingByAttributeWidget({
					...
					tooltipContent: t('Use this number to set the correct position of this option in the sequence.')
				})
			],
			blockOutsideAfter: [
				createElementMenuButtonWidget()
		...
		configureProperties(sxModule, 'self::lcSequenceOption2[number(string(child::lcSequence2/@value)) gt count(parent::lcSequenceOptionGroup2/lcSequenceOption2)]', {
			blockAfter: [
				createIconWidget('exclamation-triangle', {
					tooltipContent: t('The ordering value can not be higher then the number of options')
				})
			],
		...
		configureProperties(sxModule, 'self::lcSequenceOption2[child::lcSequence2/@value = preceding-sibling::lcSequenceOption2/lcSequence2/@value or child::lcSequence2/@value = following-sibling::lcSequenceOption2/lcSequence2/@value]', {
			blockAfter: [
				createIconWidget('exclamation-triangle', {
